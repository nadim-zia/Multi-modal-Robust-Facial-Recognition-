...
class MTCNN():
    ...
    def align(self, img):
        ...
        facial5points = [[landmarks[0][j], landmarks[0][j + 5]] for j in range(5)]
        # print(f'facial points are as under(1)',facial5points)

        # _, landmarks = self.detect_faces(img)
        # facial5points = [[landmarks[0][j],landmarks[0][j+5]] for j in range(5)]
        warped_face = warp_and_crop_face(np.array(img), facial5points, self.refrence, crop_size=(112,112), align_type = 'cv2_affine')
        # Image.show(warped_face)
        # print(f'here is the type of wraped face from mtccn aling function',type(warped_face))
    ...
    def align_multi(self, img, limit=None, min_face_size=20.0):
        ...
        for landmark in landmarks:
            ...
            # print(f'facial points are as under',facial5points)
